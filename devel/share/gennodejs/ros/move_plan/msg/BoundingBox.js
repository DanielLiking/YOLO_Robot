...
class BoundingBox {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.string(obj.angle, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.angle = _deserializer.string(buffer, bufferOffset);
    return data;
  }
