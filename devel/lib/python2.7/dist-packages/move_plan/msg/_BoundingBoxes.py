...
"""autogenerated by genpy from move_plan/BoundingBoxes.msg. Do not edit."""
import codecs
import sys
...
import move_plan.msg
import std_msgs.msg

class BoundingBoxes(genpy.Message):
  _md5sum = "214eaf8c7004aa544b3f5d5cd7a507b4"
  _type = "move_plan/BoundingBoxes"
...
string angle"""
  ...
  _slot_types = ['std_msgs/Header','std_msgs/Header','move_plan/BoundingBox[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = move_plan.msg.BoundingBox()
        _x = val1
        start = end
        end += 42
        ...
        if python3:
          val1.angle = str[start:end].decode('utf-8', 'rosmsg')
        else:
          val1.angle = str[start:end]
